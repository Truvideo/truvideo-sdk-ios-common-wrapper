...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Shared",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-shared/releases/download/0.0.38/shared.xcframework.zip",
            checksum: "525c2ed61fd80ce188a89820c640f4c48404a6fb1988220a742c1fe08db6c777"
        ),
        .target(
            name: "CommonTargets",
            dependencies: [
