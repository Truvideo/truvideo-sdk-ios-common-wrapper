...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Shared",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-shared/releases/download/0.0.63/shared.xcframework.zip",
            checksum: "437b6f126d82ce0831c74f347f2dba00693d72fecfdd49497046464788c779ec"
        ),
        .target(
            name: "CommonTargets",
            dependencies: [
