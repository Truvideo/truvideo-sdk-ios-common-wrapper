...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Shared",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-shared/releases/download/0.0.34/shared.xcframework.zip",
            checksum: "d4a826866f3963de73a9d2df9fa9b95bc0202107f8295dccf24eff01c49a4f90"
        ),
        .target(
            name: "CommonTargets",
            dependencies: [
