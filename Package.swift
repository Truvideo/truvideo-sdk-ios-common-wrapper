...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Shared",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-shared/releases/download/0.0.31/shared.xcframework.zip",
            checksum: "a173d9ef714d443074711cfcb5f60195795afcad681336fa6d468fa8a212fb1e"
        ),
        .target(
            name: "CommonTargets",
            dependencies: [
